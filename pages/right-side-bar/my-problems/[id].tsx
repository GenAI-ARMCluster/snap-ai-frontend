// path: pages/right-side-bar/my-problems/[id].tsx
...
// 예시로 사용된 내가 작성한 문제 데이터
const mockMyProblems: ProblemDetail[] = [
  {
    id: 1,
    title: "최단거리 문제",
...
const MyProblemDetail: React.FC = () => {
  ...
  useEffect(() => {
    if (id) {
      // Mock 데이터에서 문제를 찾는다
      const problem = mockMyProblems.find(
    ...
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col">
      <div className="container mx-auto flex flex-grow space-x-6">
        ...
        <div className="w-1/2 bg-white p-6 rounded-lg shadow-lg flex-grow">
          ...
          <p className="text-gray-600 mb-2">작성 날짜: {problemDetail.date}</p>

          <h2 className="text-2xl font-bold text-gray-800 mb-4">제출된 코드</h2>
        ...
        <div className="w-1/2 flex flex-col space-y-6">
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-indigo-600 mb-4">문제 수정하기</h2>
            <textarea
              value={userCode}
...
export default MyProblemDetail;
